    ...
    <>
      ...
      <Stepper orientation='vertical' sx={{float: 'left'}}>
        <Step active={true} sx={stepStyle}>
          <StepLabel> <span> Select template </span></StepLabel>
        </Step>
        <Step active={true} sx={stepStyle}>
          <StepLabel> Add texts</StepLabel>
          <div style={{ height: '50px' }}>
            <div style={{ borderLeft: '1px solid #ccc', height: '100%', marginLeft: '12px' }}></div>
          </div>
        </Step>
        <Step active={true} sx={stepStyle}>
      ...
      <div className="meme-container">
        <div>
          ...
          <Button variant="contained" size="small" onClick={props.download} sx={{marginTop: '30px'}}>Download Meme</Button>
        </div>
        <div className="meme">
          <svg
            id="svg_ref"
